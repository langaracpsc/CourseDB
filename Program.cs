...
namespace CourseDB
{
    class Program
    {
        ...
        static Course ParseNode(string[] entries)
        {
            ...
            Double.TryParse(splitArray[10], out fees);
            Double.TryParse(splitArray[9], out credits);
             
            return new Course(ints[0],
                    ints[1],
                    ints[2],
                    splitArray[17],
                    splitArray[6],
                    ints[3],
                    splitArray[8],
                    credits,//Convert.ToInt32(splitArray[3]),
                    splitArray[10],
                    fees,
                    ints[5],
                    splitArray[12],
        ...
        static void Main(string[] args)
         {
           ...
           // FileIO.Write(jsonString, "courseDump.json");
            ...
            //Program.PrintArray(Tools.DivideString(args[0], Convert.ToInt32(args[1])));
